    ...
    <div class="admin-container">
      <div class="admin-header">
        ...
        <div>
          ...
          <button class="btn btn-primary" style="background:#087f79; border-color:#087f79; margin-right:8px;" onclick="window.open('/linkup.html?room=' + roomCode, '_blank')">Open LinkUp Dashboard ↗</button>
